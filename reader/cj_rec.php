...
<body>
    ...
    <div class="left-section">
        ...
        <p style="text-align:center;">
            <input type="button" class="history-btn" name="send" value="推薦紀錄" onclick="location.href='cj_record.php'" />
        </p>
    ...
    <div class="right-section">
        ...
        <h2 id="tit" style="margin-left:20%">推 薦 期 刊&emsp;&nbsp;&nbsp;&nbsp;
        ...
        <div style="color:#203057; font-family:Times New Roman,'DFKai-sb'; font-size:24px; float:left; margin-left:28%">
            <form method="post" action="cjr_judge.php" id="subform">
                <!-- 書名欄位 -->
                <label for="title" class="required-label">刊名：</label>
                <input type="text" style="width:389px;" id="title" name="title" required autocomplete="off"
                    onchange="value=value.replace(/[^\a-\z\A-\Z0-9\u4E00-\u9FA5]/g,'')"><br><br>
                <!-- 出版社欄位 -->
                <label for="publish" class="required-label">出版社：</label>
                <input type="text" style="width:365px;" id="publish" name="publish" required autocomplete="off"
                    onchange="value=value.replace(/[^\a-\z\A-\Z0-9\u4E00-\u9FA5]/g,'')"><br><br>
                <!-- 出版社電話欄位 -->
                <label for="publishTel">出版社電話：</label>
                <input type="text" style="width:333px;" id="publishTel" name="publishTel" autocomplete="off"
                    onchange="value=value.replace(/[^\a-\z\A-\Z0-9\u4E00-\u9FA5]/g,'')"><br><br>
                <!-- ISSN欄位 -->
                <label for="issn" class="required-label">ISSN：</label>
                <input type="text" style="width:212px;" id="issn" name="issn" required autocomplete="off"
                    onchange="value=value.replace(/[^\a-\z\A-\Z0-9\u4E00-\u9FA5]/g,'')">&emsp;
                <!-- 價格欄位 -->
                <label for="price">價格：</label>
                <input type="text" style="width:65px;" id="price" name="price" autocomplete="off"
                    onchange="value=value.replace(/[^\a-\z\A-\Z0-9\u4E00-\u9FA5]/g,'')"><br><br>
                <!-- 理由欄位 -->
