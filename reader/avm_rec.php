...
<body>
    ...
    <div class="left-section">
        ...
        <p style="text-align:center;">
            <input type="button" class="history-btn" name="send" value="推薦紀錄"
                onclick="location.href='avm_record.php'" />
        </p>
    ...
    <div class="right-section">
        ...
        <h2 id="tit" style="margin-left:20%">推 薦 視 聽&emsp;&nbsp;&nbsp;&nbsp;
        ...
        <div style="color:#203057; font-family:Times New Roman,'DFKai-sb'; font-size:24px; float:left; margin-left:28%">
            <form method="post" action="avmr_judge.php" id="subform">
                <!-- 預約選項欄位 -->
                ...
                <!-- 名稱欄位 -->
                <label for="video" class="required-label">名稱：</label>
                <input type="text" style="width:389px;" id="video" name="video" required autocomplete="off"
                    onchange="value=value.replace(/[^\a-\z\A-\Z0-9\u4E00-\u9FA5]/g,'')"><br><br>
                <!-- 作者欄位 -->
                <label for="auth" class="required-label">作者：</label>
                <input type="text" style="width:389px;" id="auth" name="auth" required autocomplete="off"
                    onchange="value=value.replace(/[^\a-\z\A-\Z0-9\u4E00-\u9FA5]/g,'')"><br><br>
                <!-- 出版社欄位 -->
                ...
                <input type="text" style="width:365px;" id="publish" name="publish" required autocomplete="off"
                    onchange="value=value.replace(/[^\a-\z\A-\Z0-9\u4E00-\u9FA5]/g,'')"><br><br>
                <!-- 網址欄位 -->
                <label for="IntroUrl">請提供您查得此視聽資料的網址：</label><br>
