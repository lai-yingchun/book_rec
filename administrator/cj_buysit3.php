...
<head>
    ...
    <script language="javascript">
        ...
        function Search() {
            ...
            if (temp_search != '') {
                location.href = "cj_buysit3.php?search=" + temp_search;
            }
            else {
                location.href = "cj_buysit3.php";
            };
        }
        ...
        function changeState() {
            ...
            if (Sno != '' && selected != '') {
                location.href = "cj_buysit3.php?Sno=" + Sno.innerHTML + "&newState=" + selected;
            }
            else {
                location.href = "cj_buysit3.php";
            }
    ...
    <nav class="navbar navbar-light" style="width:95%;">
        <div class="container-fluid" style="margin-left:5.5%;">
            <ul class="nav nav-tabs">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="cj_buysit3.php"
            ...
            <div id="cj_table" style="width:100%;">
                <table class="table table-striped table-hover" id="record-table" align="center">
                    ...
                    <tbody>
                        ...
                        // 算筆數
                        $sql_view = "SELECT * FROM hrec_cj WHERE `situation` LIKE '編目中' AND `empty` LIKE '否'";
                        if (isset($_GET['search'])) {
                            $search = $_GET['search'];
        ...
        <nav aria-label="Page navigation example" style="font-family:'Times New Roman';">
            <ul class="pagination justify-content-center">
                ...
                <li class="page-item">
                    <?php
                    if (isset($_GET['search'])) {
                        echo '<a class="page-link" href="cj_buysit3.php?page=1&search=' . $search . '" aria-label="Previous">';
                        echo '<span aria-hidden="true">&laquo;</span>';
                        echo '</a>';
                    } else {
                        echo '<a class="page-link" href="cj_buysit3.php?page=1" aria-label="Previous">';
                        echo '<span aria-hidden="true">&laquo;</span>';
                        echo '</a>';
                    }
                    ?>
                ...
                <li class="page-item">
                    ...
                    if (isset($_GET['search'])) {
                        if (isset($_GET['page'])) {
                            ...
                            echo '<a class="page-link" href="cj_buysit3.php?page=' . $p . '&search=' . $search . '" aria-label="Previous">';
                        ...
                        if (isset($_GET['page'])) {
                            ...
                            echo '<a class="page-link" href="cj_buysit3.php?page=' . $p . '" aria-label="Previous">';
                            echo '<span aria-hidden="true">&lt;</span>';
                            echo '</a>';
                        } else {
                            echo '<a class="page-link" href="cj_buysit3.php?page=1" aria-label="Previous">';
                ...
                if (isset($_GET['search'])) {
                    if (isset($number)) {
                        if ($number <= 3) {
                            for ($i = 1; $i <= $number; $i++) {
                                echo '<li class="page-item"><a class="page-link" href="cj_buysit3.php?page=' . $i . '&search=' . $search . '" style="color:#203057;">' . $i . '</a></li>';
                            }
                        } else {
                            if (isset($_GET['page'])) {
                                $p = intval($_GET['page']);
                                if ($p >= 3) {
                                    if (($p + 1) > $number) {
                                        echo '<li class="page-item"><a class="page-link" href="cj_buysit3.php?page=' . ($p - 2) . '&search=' . $search . '" style="color:#203057;">' . ($p - 2) . '</a></li>';
                                        echo '<li class="page-item"><a class="page-link" href="cj_buysit3.php?page=' . ($p - 1) . '&search=' . $search . '" style="color:#203057;">' . ($p - 1) . '</a></li>';
                                        echo '<li class="page-item"><a class="page-link" href="cj_buysit3.php?page=' . $number . '&search=' . $search . '" style="color:#203057;">' . $number . '</a></li>';
                                    } else {
                                        echo '<li class="page-item"><a class="page-link" href="cj_buysit3.php?page=' . ($p - 1) . '&search=' . $search . '" style="color:#203057;">' . ($p - 1) . '</a></li>';
                                        echo '<li class="page-item"><a class="page-link" href="cj_buysit3.php?page=' . $p . '&search=' . $search . '" style="color:#203057;">' . $p . '</a></li>';
                                        echo '<li class="page-item"><a class="page-link" href="cj_buysit3.php?page=' . ($p + 1) . '&search=' . $search . '" style="color:#203057;">' . ($p + 1) . '</a></li>';
                                    }
                                } else {
                                    echo '<li class="page-item"><a class="page-link" href="cj_buysit3.php?page=1&search=' . $search . '" style="color:#203057;">1</a></li>';
                                    echo '<li class="page-item"><a class="page-link" href="cj_buysit3.php?page=2&search=' . $search . '" style="color:#203057;">2</a></li>';
                                    echo '<li class="page-item"><a class="page-link" href="cj_buysit3.php?page=3&search=' . $search . '" style="color:#203057;">3</a></li>';
                                }
                            } else {
                                echo '<li class="page-item"><a class="page-link" href="cj_buysit3.php?page=1&search=' . $search . '" style="color:#203057;">1</a></li>';
                                echo '<li class="page-item"><a class="page-link" href="cj_buysit3.php?page=2&search=' . $search . '" style="color:#203057;">2</a></li>';
                    ...
                    if (isset($number)) {
                        if ($number <= 3) {
                            for ($i = 1; $i <= $number; $i++) {
                                echo '<li class="page-item"><a class="page-link" href="cj_buysit3.php?page=' . $i . '" style="color:#203057;">' . $i . '</a></li>';
                            }
                        } else {
                            if (isset($_GET['page'])) {
                                $p = intval($_GET['page']);
                                if ($p >= 3) {
                                    if (($p + 1) > $number) {
                                        echo '<li class="page-item"><a class="page-link" href="cj_buysit3.php?page=' . ($p - 2) . '" style="color:#203057;">' . ($p - 2) . '</a></li>';
                                        echo '<li class="page-item"><a class="page-link" href="cj_buysit3.php?page=' . ($p - 1) . '" style="color:#203057;">' . ($p - 1) . '</a></li>';
                                        echo '<li class="page-item"><a class="page-link" href="cj_buysit3.php?page=' . $number . '" style="color:#203057;">' . $number . '</a></li>';
                                    } else {
                                        echo '<li class="page-item"><a class="page-link" href="cj_buysit3.php?page=' . ($p - 1) . '" style="color:#203057;">' . ($p - 1) . '</a></li>';
                                        echo '<li class="page-item"><a class="page-link" href="cj_buysit3.php?page=' . $p . '" style="color:#203057;">' . $p . '</a></li>';
                                        echo '<li class="page-item"><a class="page-link" href="cj_buysit3.php?page=' . ($p + 1) . '" style="color:#203057;">' . ($p + 1) . '</a></li>';
                                    }
                                } else {
                                    echo '<li class="page-item"><a class="page-link" href="cj_buysit3.php?page=1" style="color:#203057;">1</a></li>';
                                    echo '<li class="page-item"><a class="page-link" href="cj_buysit3.php?page=2" style="color:#203057;">2</a></li>';
                                    echo '<li class="page-item"><a class="page-link" href="cj_buysit3.php?page=3" style="color:#203057;">3</a></li>';
                                }
                            } else {
                                echo '<li class="page-item"><a class="page-link" href="cj_buysit3.php?page=1" style="color:#203057;">1</a></li>';
                                echo '<li class="page-item"><a class="page-link" href="cj_buysit3.php?page=2" style="color:#203057;">2</a></li>';
                    ...
                    if (isset($_GET['search'])) {
                        if (isset($_GET['page'])) {
                            ...
                            if ($number == 1) {
                                ...
                                echo '<a class="page-link" href="cj_buysit3.php?page=2&search=' . $search . '" aria-label="Previous">';
                                echo '<span aria-hidden="true">&gt;</span>';
                                echo '</a>';
                            }
                        }
                        ...
                        if (isset($_GET['page'])) {
                            ...
                            if ($number == 1) {
                                ...
                                echo '<a class="page-link" href="cj_buysit3.php?page=2" aria-label="Previous">';
                                echo '<span aria-hidden="true">&gt;</span>';
                                echo '</a>';
                            }
                        }
                ...
                <li class="page-item">
                    <?php
                    if (isset($_GET['search'])) {
                        echo '<a class="page-link" href="cj_buysit3.php?page=' . $number . '&search=' . $search . '" aria-label="Previous">';
                        echo '<span aria-hidden="true">&raquo;</span>';
                        echo '</a>';
                    } else {
                        echo '<a class="page-link" href="cj_buysit3.php?page=' . $number . '" aria-label="Previous">';
                        echo '<span aria-hidden="true">&raquo;</span>';
                        echo '</a>';
                    }
                    ?>
